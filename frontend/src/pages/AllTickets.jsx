...
export default function AllTickets({ fetchData }) {
  const data = use(fetchData);

  return (
    <div className="md:basis-2/3">
      <h1 className="text-3xl">Customer Tickets</h1>
      <div className="grid grid-cols-2 gap-7 py-7">
        {data.map((ticket) => (
          <div key={ticket.id} className="bg-base-200 p-6 rounded-xl shadow-sm flex flex-col justify-between">
